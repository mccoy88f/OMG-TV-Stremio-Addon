const config = {
    ...
    // Content sources
    M3U_URL: 'https://example.com/link.playlist', // URL del file con le playlist M3U
    EPG_URL: process.env.EPG_URL || 'https://example.com/link.epg', // URL del file con gli EPG
